...
interface Trial3DayEmailProps {
  userName?: string;
  upgradeLink?: string;
}

export const Trial3DayEmail = ({
  userName = "there",
  ...
  return (
    <Html>
      <Head />
      <Preview>Lock In Your Advantage. Keep dealing from the top.</Preview>
      <Body style={main}>
        <Container style={container}>
          <Text style={logoText}>byrd</Text>

          <Text style={title}>Lock In Your Advantage</Text>

          <Text style={subtitle}>Stack the deck in your favor</Text>

          <Section style={messageSection}>
            <Text style={messageText}>Hi {userName},</Text>
            <Text style={messageText}>
              The countdown is on. In 3 days, your competitors get their
              blindspots back. Unless you choose differently.
            </Text>
            <Text style={messageText}>
